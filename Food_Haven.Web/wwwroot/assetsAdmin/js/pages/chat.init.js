function searchMessages() {
    var t, s = document.getElementById("searchMessage").value.toUpperCase(), e = document.getElementById("users-conversation").getElementsByTagName("li");
    Array.from(e).forEach(function (e) {
        t = e.getElementsByTagName("p")[0] ? e.getElementsByTagName("p")[0] : "",
            -1 < (t.textContent || t.innerText ? t.textContent || t.innerText : "").toUpperCase().indexOf(s) ? e.style.display = "" : e.style.display = "none"
    })
}
!function () {
    var r = "/assetsAdmin/images/users/user-dummy-img.jpg"
        , n = "/assetsAdmin/images/users/multi-user.jpg"
        , o = !1;
    function s() {
    ...
    function u(e, t, s, n, a) {
        ...
        if (null != t)
            r += '<div class="ctext-wrap-content" id=' + e + '><p class="mb-0 ctext-content">' + t + "</p></div>";
        else if (s && 0 < s.length) {
            for (r += '<div class="message-img mb-0">',
                i = 0; i < s.length; i++)
                r += '<div class="message-img-list">                <div>                    <a class="popup-img d-inline-block" href="' + s[i] + '">                        <img src="' + s[i] + '" alt="" class="rounded border">                    </a>                </div>                <div class="message-img-link">                <ul class="list-inline mb-0">                    <li class="list-inline-item dropdown">                        <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                            <i class="ri-more-fill"></i>                        </a>                        <div class="dropdown-menu">                            <a class="dropdown-item" href="' + s[i] + '" download=""><i class="ri-download-2-line me-2 text-muted align-bottom"></i>Download</a>                            <a class="dropdown-item" href="#"><i class="ri-reply-line me-2 text-muted align-bottom"></i>Reply</a>                            <a class="dropdown-item" href="#"><i class="ri-share-line me-2 text-muted align-bottom"></i>Forward</a>                            <a class="dropdown-item" href="#"><i class="ri-bookmark-line me-2 text-muted align-bottom"></i>Bookmark</a>                            <a class="dropdown-item delete-image" href="#"><i class="ri-delete-bin-5-line me-2 text-muted align-bottom"></i>Delete</a>                        </div>                    </li>                </ul>                </div>            </div>';
            r += "</div>"
        } else
            0 < n.length && (r += '<div class="ctext-wrap-content">            <div class="p-3 border-primary border rounded-3">            <div class="d-flex align-items-center attached-file">                <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">                    <div class="avatar-title bg-primary-subtle text-primary rounded-circle font-size-20">                        <i class="ri-attachment-2"></i>                    </div>                </div>                <div class="flex-grow-1 overflow-hidden">                    <div class="text-start">                        <h5 class="font-size-14 mb-1">design-phase-1-approved.pdf</h5>                        <p class="text-muted text-truncate font-size-13 mb-0">12.5 MB</p>                    </div>                </div>                <div class="flex-shrink-0 ms-4">                    <div class="d-flex gap-2 font-size-20 d-flex align-items-start">                        <div>                            <a href="#" class="text-muted">                                <i class="bx bxs-download"></i>                            </a>                        </div>                    </div>                </div>            </div>            </div>        </div>');
    ...
    function p() {
        "users" == c ? (document.getElementById("channel-chat").style.display = "none",
            document.getElementById("users-chat").style.display = "block") : (document.getElementById("channel-chat").style.display = "block",
    ...
    function t(e) {
        ...
        e = e,
            t = function (e, t) {
                var a, r, s, n, l, i;
                null !== e ? console.log("Something went wrong: " + e) : (a = "users" == c ? t[0].chats : t[0].channel_chat,
                    document.getElementById(c + "-conversation").innerHTML = "",
                    r = 0,
                    a.forEach(function (t, e) {
                        var s, n;
                        0 < r ? r -= 1 : (n = t.from_id == m ? " right" : " left",
                            s = d.find(function (e) {
                                return e.id == t.to_id
                            }),
                            ...
                            a[e + 1] && t.from_id == a[e + 1].from_id && (r = function (e, t, s) {
                                for (var n = 0; e[t] && e[t + 1] && e[t + 1].from_id == s;)
                                    n++,
                                        t++;
                                return n
                            }(a, e, t.from_id),
                                n += function (e, t, s) {
                                    for (var n = 0; e[t] && e[t + 1] && e[t + 1].from_id == s;)
                                        n = u(e[t + 1].id, e[t + 1].msg, e[t + 1].has_images, e[t + 1].has_files, e[t + 1].has_dropDown),
                                            t++;
                                    return n
                                }(a, e, t.from_id)),
                            n = n + ('<div class="conversation-name"><span class="d-none name">' + s.name + '</span><small class="text-muted time">' + t.datetime) + '</small> <span class="text-success check-message-icon"><i class="bx bx-check-double"></i></span></div></div>                </div>            </li>',
                    ...
                    e.forEach(function (t) {
                        t.addEventListener("click", function () {
                            ...
                            var e = t.closest(".ctext-wrap").children[0].children[0].innerText
                                , e = (document.querySelector(".replyCard .replymessage-block .flex-grow-1 .mb-0").innerText = e,
                                    document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML)
                    ...
                    t.forEach(function (t) {
                        t.addEventListener("click", function () {
                            ...
                            var e = t.closest(".ctext-wrap").children[0].children[0].innerText
                                , e = (document.querySelector(".replyCard .replymessage-block .flex-grow-1 .mb-0").innerText = e,
                                    t.closest(".user-chat-content").querySelector(".conversation-name .name").innerText)
                                , e = !t.closest(".chat-list") || t.closest(".chat-list").classList.contains("left") ? e : "You";
                            document.querySelector(".replyCard .replymessage-block .flex-grow-1 .conversation-name").innerText = e
                        })
                    }),
            ...
            s.onload = function () {
                ...
                200 === e ? (document.getElementById("elmLoader").innerHTML = "",
                    t(null, s.response)) : t(e, s.response)
            }
            ,
            s.send()
    }
        ...
        null !== e ? console.log("Something went wrong: " + e) : (t[0].users.forEach(function (e, t) {
            ...
            t[0].channels.forEach(function (e, t) {
                var s = e.messagecount ? '<div class="flex-shrink-0 ms-2"><span class="badge bg-dark-subtle text-body rounded p-1">' + e.messagecount + "</span></div>" : ""
                    , n = (e.messagecount && e.messagecount,
                        e.messagecount ? '<a href="javascript: void(0);" class="unread-msg-user">' : '<a href="javascript: void(0);">');
            ...
            document.querySelectorAll("#userList li").forEach(function (n) {
                n.addEventListener("click", function () {
                    ...
                    document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = s,
                        ...
                        document.getElementById(e).querySelector(".userprofile") ? (t = document.getElementById(e).querySelector(".userprofile").getAttribute("src"),
                            document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", t),
                            document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", t)) : (document.querySelector(".user-chat-topbar .avatar-xs").setAttribute("src", r),
                                document.querySelector(".profile-offcanvas .avatar-lg").setAttribute("src", r)),
                ...
                d.forEach(function (e, t) {
                    var s = e.profile ? '<img src="' + e.profile + '" class="img-fluid rounded-circle" alt="">' : '<span class="avatar-title rounded-circle bg-primary fs-10">' + e.nickname + "</span>"
                        , s = (n = '<li>              <div class="d-flex align-items-center">                  <div class="flex-shrink-0 me-2">                      <div class="avatar-xxs">                          ' + s + '                      </div>                  </div>                  <div class="flex-grow-1">                  <p class="text-truncate contactlist-name mb-0">' + e.name + '</p>                  </div>                  <div class="flex-shrink-0">                      <div class="dropdown">                          <a href="#" class="text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                              <i class="ri-more-2-fill"></i>                          </a>                          <div class="dropdown-menu dropdown-menu-end">                              <a class="dropdown-item" href="#"><i class="ri-pencil-line text-muted me-2 align-bottom"></i>Edit</a>                              <a class="dropdown-item" href="#"><i class="ri-forbid-2-line text-muted me-2 align-bottom"></i>Block</a>                              <a class="dropdown-item" href="#"><i class="ri-delete-bin-6-line text-muted me-2 align-bottom"></i>Remove</a>                          </div>                      </div>                  </div>              </div>          </li>',
                            '<div class="mt-3" >              <div class="contact-list-title">' + e.name.charAt(0).toUpperCase() + '                </div>          <ul id="contact-sort-' + e.name.charAt(0) + '" class="list-unstyled contact-list" >');
                ...
                document.querySelectorAll(".sort-contact ul li").forEach(function (n) {
                    n.addEventListener("click", function (e) {
                        ...
                        document.querySelector(".user-chat-topbar .text-truncate .username").innerHTML = s,
                            ...
                            1 == o && (o = !1,
                                document.querySelector(".replyCard").classList.remove("show")),
                            n.querySelector(".align-items-center").querySelector(".avatar-xxs img") ? (t = n.querySelector(".align-items-center").querySelector(".avatar-xxs .rounded-circle").getAttribute("src"),
                                document.querySelector(".user-own-img .avatar-xs").setAttribute("src", t),
                                document.querySelector(".profile-offcanvas .profile-img").setAttribute("src", t)) : (document.querySelector(".user-own-img .avatar-xs").setAttribute("src", r),
                                    document.querySelector(".profile-offcanvas .profile-img").setAttribute("src", r)),
                            document.getElementById("users-conversation").querySelectorAll(".left .chat-avatar").forEach(function (e) {
                                t ? e.querySelector("img").setAttribute("src", t) : e.querySelector("img").setAttribute("src", r)
                            }),
                            window.stop()
    ...
    f && f.addEventListener("submit", function (e) {
        ...
        var e = a
            , t = a
            , s = g.value;
        0 === s.length ? (h.classList.add("show"),
            setTimeout(function () {
            ...
            n.querySelectorAll(".reply-message").forEach(function (a) {
                a.addEventListener("click", function () {
                    ...
                    document.querySelector(".replyCard .replymessage-block .flex-grow-1 .conversation-name").innerText = t,
                        document.querySelector(".replyCard .replymessage-block .flex-grow-1 .mb-0").innerText = s
                })
            })
    }
        , k = function (e, t) {
                ...
                a.querySelectorAll(".reply-message").forEach(function (s) {
                    s.addEventListener("click", function () {
                        var e = s.closest(".ctext-wrap").children[0].children[0].innerText
                            ...
                            , e = (document.querySelector(".replyCard .replymessage-block .flex-grow-1 .mb-0").innerText = e,
                                !s.closest(".chat-list") || s.closest(".chat-list").classList.contains("left") ? t : "You");
                        document.querySelector(".replyCard .replymessage-block .flex-grow-1 .conversation-name").innerText = e
                    })
                }),
                a.querySelectorAll(".copy-message").forEach(function (e) {
                    e.addEventListener("click", function () {
                        a.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute("id"),
                            isText = a.childNodes[1].children[1].firstElementChild.firstElementChild.innerText,
    ...
    document.getElementById("emoji-btn").addEventListener("click", function () {
        setTimeout(function () {
            ...
            t && (e = window.getComputedStyle(t) ? window.getComputedStyle(t).getPropertyValue("left") : "") && (e = e.replace("px", ""),
