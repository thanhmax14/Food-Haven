...
namespace Food_Haven.UnitTest.Admin_CreateTypeOfDish_Test
{
    [TestFixture]
    public class CreateTypeOfDish_Test
    {
        ...
        public void Setup()
        {
            ...
            // Setup AddAsync and SaveChangesAsync to avoid NullReferenceException
            _typeOfDishServiceMock.Setup(x => x.AddAsync(It.IsAny<TypeOfDish>())).Returns(Task.CompletedTask);
            ...
            // Fix: Setup TempData to avoid NullReferenceException
        ...
        [Test]
        public async Task CreateTypeOfDish_ReturnsView_WhenModelStateIsInvalid()
        {
            // Arrange
            var model = new TypeOfDishViewModel { Name = "", IsActive = true };
            _controller.ModelState.AddModelError("Name", "Required");

            // Act
            var result = await _controller.CreateTypeOfDish(model);
        ...
        [Test]
        public async Task CreateTypeOfDish_ReturnsView_WhenNameExists()
        {
            // Arrange
            var model = new TypeOfDishViewModel { Name = "Trung", IsActive = true };
            _typeOfDishServiceMock.Setup(x => x.ExistsAsync(model.Name)).ReturnsAsync(true);
        ...
        [Test]
        public async Task CreateTypeOfDish_Redirects_WhenSuccess()
        {
            // Arrange
            var model = new TypeOfDishViewModel { Name = "MonMoi", IsActive = true };
            _typeOfDishServiceMock.Setup(x => x.ExistsAsync(model.Name)).ReturnsAsync(false);
