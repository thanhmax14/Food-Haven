...
namespace Food_Haven.UnitTest.Admin_ShowAccount_Test
{
    [TestFixture]
    public class ShowAccount_Test
    {
        ...
        [Test]
        public async Task ShowAccount_UserNotFound_ReturnsJsonError()
        {
            ...
            var result = await _controller.ShowAccount(new UsersViewModel { Email = "user@email.com" }) as JsonResult;
        ...
        [Test]
        public async Task ShowAccount_Success_ReturnsJsonSuccess()
        {
            var admin = new AppUser { UserName = "admin" };
            ...
            Assert.AreEqual("User account unbanned successfully", type.GetProperty("message")?.GetValue(value));
        }
    }
}
