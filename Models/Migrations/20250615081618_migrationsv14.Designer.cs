...
namespace Models.Migrations
{
    ...
    [Migration("20250615081618_migrationsv14")]
            ...
            modelBuilder.Entity("Models.IngredientTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("32797bb0-9971-4035-ab30-0fac3f31907b"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9922),
                            IsActive = true,
                            Name = "Fish"
                        },
                        new
                        {
                            ID = new Guid("26631dd2-cb66-4467-8825-96e5cee81c4b"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9926),
                            IsActive = true,
                            Name = "Chicken"
                        },
                        new
                        {
                            ID = new Guid("cbda0ee9-1bd9-4c30-9426-8d4f1454111b"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9929),
                            IsActive = true,
                            Name = "Beef"
                        },
                        new
                        {
                            ID = new Guid("37bdf07d-6f2c-4cde-b5c8-a55d5c048f49"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9933),
                            IsActive = true,
                            Name = "Pork"
                        },
                        new
                        {
                            ID = new Guid("415b1190-57d9-4622-abb9-02e78adb395d"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9937),
                            IsActive = true,
                            Name = "Seafood"
                        },
                        new
                        {
                            ID = new Guid("97e16152-9605-4503-a11b-bf5fa9839c21"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9940),
                            IsActive = true,
                            Name = "Vegetable"
                        });
                });
            ...
            modelBuilder.Entity("Models.TypeOfDish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("62332def-2bdc-4e1b-804e-0fa45be6b750"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9440),
                            IsActive = true,
                            Name = "Quick and Easy Dinners for One"
                        },
                        new
                        {
                            ID = new Guid("e5c249f7-dc50-48ee-98a4-2466c3f345b8"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9445),
                            IsActive = true,
                            Name = "Cooking for Two"
                        },
                        new
                        {
                            ID = new Guid("13dedd2c-c681-4a39-88ca-b6c773704eb0"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9449),
                            IsActive = true,
                            Name = "Main Dishes"
                        },
                        new
                        {
                            ID = new Guid("2542a75a-0395-4436-b039-b63a26705853"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9452),
                            IsActive = true,
                            Name = "Vegetarian Main Dishes"
                        },
                        new
                        {
                            ID = new Guid("258be550-e959-48be-af41-99918cebbfb9"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9456),
                            IsActive = true,
                            Name = "Side Dishes"
                        },
                        new
                        {
                            ID = new Guid("53cf5a0d-9bd7-4f2e-b8d6-a946ea4c539e"),
                            CreatedDate = new DateTime(2025, 6, 15, 15, 16, 17, 273, DateTimeKind.Local).AddTicks(9475),
                            IsActive = true,
