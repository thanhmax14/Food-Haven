...
namespace Models.Migrations
{
    ...
    [Migration("20250531152643_migrationsv7")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IngredientTagRecipe", b =>
                {
                    ...
                    b.HasKey("IngredientTagsID", "RecipesID");

                    b.HasIndex("RecipesID");

                    b.ToTable("RecipeIngredientTags", (string)null);
                });
            ...
            modelBuilder.Entity("Models.IngredientTag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("03adc024-ac3b-4bcc-823a-8571f4bccc80"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3490),
                            IsActive = true,
                            Name = "Fish"
                        },
                        new
                        {
                            ID = new Guid("1d514df3-2e41-46c8-83c1-4b9b296c3441"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3494),
                            IsActive = true,
                            Name = "Chicken"
                        },
                        new
                        {
                            ID = new Guid("dbe1a64d-511b-4ffc-a82b-0eb40abc989b"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3497),
                            IsActive = true,
                            Name = "Beef"
                        },
                        new
                        {
                            ID = new Guid("f0382441-edaa-48b5-8038-e0e9b7e195d1"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3500),
                            IsActive = true,
                            Name = "Pork"
                        },
                        new
                        {
                            ID = new Guid("7fc99b4c-cd26-42d5-8f12-3c49bc2bba39"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3503),
                            IsActive = true,
                            Name = "Seafood"
                        },
                        new
                        {
                            ID = new Guid("64f424bc-41b0-4454-aa4d-408b8b429fb1"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3506),
                            IsActive = true,
                            Name = "Vegetable"
                        });
                });
            ...
            modelBuilder.Entity("Models.TypeOfDish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("6afc95e4-1efb-49f2-b9c1-a32c345c2a64"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3150),
                            IsActive = true,
                            Name = "Quick and Easy Dinners for One"
                        },
                        new
                        {
                            ID = new Guid("1f4de843-cbc1-46b0-8435-9f30e3f7498e"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3153),
                            IsActive = true,
                            Name = "Cooking for Two"
                        },
                        new
                        {
                            ID = new Guid("84a1f740-4ad2-4b39-9e23-e1c751e70c3a"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3156),
                            IsActive = true,
                            Name = "Main Dishes"
                        },
                        new
                        {
                            ID = new Guid("e2871ae1-fe0b-4192-b939-a17770df6d82"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3160),
                            IsActive = true,
                            Name = "Vegetarian Main Dishes"
                        },
                        new
                        {
                            ID = new Guid("245459d2-2e6d-4098-a2e7-85fae5c3cc96"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3162),
                            IsActive = true,
                            Name = "Side Dishes"
                        },
                        new
                        {
                            ID = new Guid("456442ed-c9e8-45c5-adc3-72144455df31"),
                            CreatedDate = new DateTime(2025, 5, 31, 22, 26, 42, 136, DateTimeKind.Local).AddTicks(3165),
                            IsActive = true,
            ...
            modelBuilder.Entity("IngredientTagRecipe", b =>
                {
                    b.HasOne("Models.IngredientTag", null)
                        .WithMany()
